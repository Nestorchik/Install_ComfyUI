...
><p align="center">В ДАЛЬНЕЙШЕМ ЗДЕСЬ, ВСЕ ОБРАЩЕНИЯ К ПИТОНУ Я БУДУ ПИСАТЬ ПРОСТО<br><br><b><font color="silver">d:\3\venv\Scripts\</font><font color="green">python</font></b>,<br><br>ПОДРАЗУМЕВАЯ, ЧТО ПИШЕТСЯ ПОЛНЫЙ ПУТЬ К ПИТОНУ ПЕРЕД НИМ!!!</P>
