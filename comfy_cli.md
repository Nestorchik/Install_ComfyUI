...
Если до установки comfy_cli в питоне вы удалили файл конфигурации "\Users\USER_NAME\AppData\Local\comfy-cli\config.ini", то comfy_cli настроится автоматически на тот экземпляр ComfyUI, который работает на этом venv, и все команды управления comfy будут направлены имеенно этому экземпляру ComfyUI.
