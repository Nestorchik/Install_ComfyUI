...
Поэтоум помните, что "для сброса" всех параметров вам надо удалить еще и папку с этим файлом! Заодно проверьте папку "Domcuments\comfy", куда он "по умолчанию" ставит ComfyUI после установки.
